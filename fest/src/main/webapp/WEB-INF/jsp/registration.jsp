...
<form id="participantFormBean" action="http://localhost:8080/paamelding" method="post">
    <fieldset>
        ...
        <input id="firstname" name="firstname" title="..." pattern=".*" placeholder="fill out firstname" required="required" type="text" value="">


        <label for="lastname">lastname</label>
        <input id="lastname" name="lastname" title="..." pattern=".*" placeholder="fill out lastname" required="required" type="text" value="">


        <label for="mobile">Mobile (8 numbers)</label>
        <input id="mobile" name="mobile" title="..." pattern=".*" placeholder="fill out phone number" required="required" type="text" value="">


        <label for="password">Password</label>
        <input id="password" name="password" title="..." pattern=".*" placeholder="Choose a password" type="password" required="required" value="">
